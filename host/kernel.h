//
// kernel.h — the Circle kernel that hosts Chocolate Doom.
//
// Device ownership: this kernel brings up interrupts, the timer, a serial
// console carrying stdio, the SD card (FatFs, holding the WAD and the
...
//   core 1   the APPLICATION core. Doom, alone: the game loop and nothing
//            else. Every platform call it makes is marshalled back to
//            core 0 by the shim.
